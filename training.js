...
function setSessionModule(mod) {
    ...
    // Reset families to all in new module so training starts with a sensible default
...
function renderSessionBuilderUI() {
    ...
    renderFamilyChips();
    // Hero position filter: meaningful for preflop only
    // (postflop spot generation filters by family which already encodes position)
